            ...
            <div className="bg-orange-500 text-white p-8 md:w-1/2 flex flex-col justify-between relative overflow-hidden rounded-md ">
               ...
               <div className="relative z-10 p-5">
                  ...
                  <div className="space-y-4">
                     ...
                     <div className="flex items-center space-x-4">
                        <FaEnvelope />
                        <span>support@indianadmission.in</span>
                     </div>
                     ...
                     <div className="flex flex-col md:flex-row gap-4">
                        <div className="flex-1">
                           ...
                           <input
                              ...
                              className="w-full border-b  text-slate-700 border-gray-300 outline-none py-1"
                           />
                        </div>
                        <div className="flex-1">
                           <label className="block text-sm font-medium">
                     ...
                     <div className="flex flex-col md:flex-row gap-4">
                        <div className="flex-1">
                           ...
                           <input
                              ...
                              className="w-full border-b border-gray-300 text-slate-700 outline-none py-1"
                           />
                        </div>
                        <div className="flex-1">
                           <label className="block text-sm font-medium">
