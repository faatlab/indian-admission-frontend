         ...
         <div>
            ...
            <div data-aos="fade-down">
               ...
               >
                  ...
                  <div className="w-[160px] lg:w-1/5 absolute flex top-100 left-32 lg:top-14 lg:left-92  transform rotate-90 lg:rotate-0">
                     <img src={curve_line} alt="" srcset="" />
                  </div>
                  ...
                  <div className="flex flex-col items-center mt-5">
                   ...
                   <div className="w-[160px] lg:w-1/5 absolute flex top-222 right-34 lg:top-14 lg:right-92 transform rotate-90 lg:rotate-0">
                     <img src={curve_line} alt="" srcset="" />
                  </div>

                  <svg
                     className="hidden w-[300px] h-[86px] lg:w-[480px] lg:h-[134px] transform rotate-90 lg:rotate-0 absolute bottom-74 right-14 lg:top-10 lg:right-45"
                     viewBox="0 0 696 134"
                     fill="none"
                     xmlns="http://www.w3.org/2000/svg"
                  >
