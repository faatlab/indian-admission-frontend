...
function Home() {
   ...
   const testimonials = [
      ...
      {
         quote: "“Complete account of the system and expound the actual Contrary system and expound the actual to popular belief, Lorem Ipsum is not simply random text. It has roots”",
            ...
            <div>
               <div className="text-center mt-10">
                  ...
                  <p className="mt-5 text-gray-500 w-1/2 mx-auto">
                     ...
                     Atque id quasi nam suscipit, minima, non tempore nobis
                     inventore excepturi dolorem possimus delectus velit omnis.
                  </p>
               </div>
               <div className="relative flex flex-col md:flex-row justify-center mt-10 gap-40">
                  <div className="flex flex-col items-center mt-5">
                     ...
                     <p className="w-80 mt-3 p-3  text-center text-slate-500">
                        ...
                        elit. Incidunt alias sapiente sed{" "}
                     </p>
                  </div>
            ...
            <section className="relative py-20 bg-white text-center overflow-hidden">
               ...
               <div className="flex flex-col md:flex-row items-center justify-center gap-6 px-4 md:px-0">
                  {testimonials.map((t, index) => (
                     ...
                     >
                        <p className="text-gray-600 italic mb-4 text-[15px]">
                           {t.quote}
                        </p>
