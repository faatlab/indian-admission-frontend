    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 mt-4 text-sm md:text-base">
          Explore courses, compare universities, track deadlines, and apply — all in one place, designed to 
          simplify your admission journey in India.
        </p>
